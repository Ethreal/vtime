"""
Django settings for vtime project.
...
SECRET_KEY = 'eb2s0ohmmq-vrjmq@u8(&j$y!^z=29ej5@v+=x)g1wo-ja72gz'
...
ROOT_URLCONF = 'vtime.urls'

WSGI_APPLICATION = 'vtime.wsgi.application'
